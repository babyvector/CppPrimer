...
StrVec::StrVec(StrVec&& sv_mv) noexcept{
    element = sv_mv.element;
    first_free = sv_mv.first_free;
    cap = sv_mv.cap;

    sv_mv.element = nullptr;
    sv_mv.first_free = nullptr;
    sv_mv.cap = nullptr;
}

StrVec& StrVec::operator=(StrVec&& sv_mv)noexcept{
